...
export class MountainRenderer {
  ...
  public render() {
    ...
    MountainEffectsRenderer.drawGradient(this.graphics, this.width, this.horizonY - 28, 14, 85, 'top')
    this.graphics.fillStyle(0xB899D8, 0.3)
    MountainEffectsRenderer.drawGradient(this.graphics, this.width, this.horizonY - 28, 14, 85, 'left')
    ...
    MountainEffectsRenderer.drawGradient(this.graphics, this.width, this.horizonY - 17, 12, 100, 'top')
    ...
    MountainEffectsRenderer.drawHighlights(this.graphics, this.width, this.horizonY - 17, 12, 100)
    this.graphics.fillStyle(0x4AC8BC, 0.25)
    MountainEffectsRenderer.drawGradient(this.graphics, this.width, this.horizonY - 17, 12, 100, 'right')
    ...
    MountainEffectsRenderer.drawGradient(this.graphics, this.width, this.horizonY - 6, 10, 72, 'top')
    
    // Sombra mágica de las montañas medias
    this.graphics.fillStyle(0x2A8C5A, 0.7)
    MountainEffectsRenderer.drawShadow(this.graphics, this.width, this.horizonY, this.horizonY - 6, 10, 18)
    ...
    MountainEffectsRenderer.drawHighlights(this.graphics, this.width, this.horizonY - 6, 10, 72)
    this.graphics.fillStyle(0x6ADCAA, 0.35)
    MountainEffectsRenderer.drawGradient(this.graphics, this.width, this.horizonY - 6, 10, 72, 'right')
    this.graphics.fillStyle(0x7AECBA, 0.25)
    MountainEffectsRenderer.drawGradient(this.graphics, this.width, this.horizonY - 6, 10, 72, 'left')
    ...
    MountainEffectsRenderer.drawGradient(this.graphics, this.width, this.horizonY, 8, 50, 'top')
    this.graphics.fillStyle(0x8A9CD4, 0.3)
    MountainEffectsRenderer.drawGradient(this.graphics, this.width, this.horizonY, 8, 50, 'left')
    
    // Sombra mágica de las montañas cercanas
    this.graphics.fillStyle(0x3A9C6B, 0.75)
    MountainEffectsRenderer.drawShadow(this.graphics, this.width, this.horizonY, this.horizonY, 8, 25)
    
    // Resaltes de luz mágica en múltiples colores
    this.graphics.fillStyle(0x6AEC9B, 0.55)
    MountainEffectsRenderer.drawHighlights(this.graphics, this.width, this.horizonY, 8, 50)
    this.graphics.fillStyle(0x7ACCF8, 0.3)
    MountainEffectsRenderer.drawHighlights(this.graphics, this.width, this.horizonY, 8, 50)
    this.graphics.fillStyle(0x8AECCB, 0.4)
    MountainEffectsRenderer.drawGradient(this.graphics, this.width, this.horizonY, 8, 50, 'right')
    
    // Detalles de textura mágica con colores vibrantes
    MountainEffectsRenderer.drawTextures(this.graphics, this.width, this.horizonY, 8, 50)
